...
import footlogo from "../assets/image/logo.webp";
const Footer = () => {
  const date = new Date();
  const year = date.getFullYear();
  return (
    <div className="bg-[#000000] md:pb-5 pb-8 pt-10 relative z-[1] mt-[70px] md:mt-[150px] overflow-x-clip ">
      <div className="max-w-[1140px] px-3 mx-auto">
        <div className="row pb-3 md:pb-7">
          <div className="xl:w-5/12 md:w-4/12 w-full px-3  pt-7">
            <img
              src={footlogo}
              alt="footlogo"
              className="cursor-pointer max-w-[209px]"
            />
            ...
            <div className="flex gap-3 pt-4">
              <a
                ...
                target="_blank"
                className=" hover:duration-300 group:"
              >
                <svg
                  className=" group"
                  width="32"
                ...
                >
                  ...
                  />
                  <path
                    className="group-hover:fill-[#F5DDAB] duration-300"
          ...
          <div className="xl:w-7/12 md:w-8/12 w-full px-3 pt-7 md:pt-10">
            <div className="row">
              <div className="lg:w-4/12 w-1/2 px-3  ">
                <ul>
                  ...
                  <li className="pb-3 sm:pb-4">
                    <a
                      href=""
                      className="text-[#cccccc] text-[13px] xl:text-base font-inter leading-[25px] lg:max-w-[369px] pt-6 font-medium  navhover transition-all duration-500 "
                    >
                      {" "}
                      Hogar
                    </a>
              ...
              <div className="lg:w-4/12 w-1/2 px-3 max-lg:pt-6 ">
                <ul>
                  <li className="text-[#ffffff] text-base font-inter leading-[25px] lg:max-w-[369px] font-bold pb-3 md:pb-5">
                    Ponerse en contacto
                  </li>
                  <li className="flex gap-1 xl:gap-2 items-center pb-3 sm:pb-4">
                    <span>
                      <svg
                        width="20"
                        height="20"
                    ...
                    <a
                      ...
                      className="text-[#cccccc] text-[13px] xl:text-base font-inter leading-[25px] navhover transition-all duration-500"
                    >
      ...
      <div className=" absolute max-w-[162px] rounded-[180px] max-h-[180px] w-full h-full bottom-[0%] left-[-6%] z-[1] bg-[linear-gradient(306.99deg,#51c8ef_-13.72%,#7AF57A_102.02%)] opacity-[0.5] blur-[75px]  "></div>
      <div className=" absolute max-w-[162px] rounded-[180px] max-h-[180px] w-full h-full top-[22%] right-[-7%] z-[-1] bg-[linear-gradient(306.99deg,#51c8ef_-13.72%,#7AF57A_102.02%)] opacity-[0.5] blur-[75px]  "></div>
    </div>
  );
};
